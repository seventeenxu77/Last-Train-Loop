...
        LockPlayerControl();
        ...
        //}
        CameraSet camS = GameObject.Find("DarkLoop").GetComponent<CameraSet>();
        camS.cams[1].enabled = false;
        Camera.main.enabled = true;
        LightManager lightM = camS.gameObject.GetComponent<LightManager>();
        lightM.TurnOnAllLights();
